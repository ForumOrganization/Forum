...
public class CommentRestController {
    ...
    @Autowired
    public CommentRestController(CommentService commentService, PostService postService, AuthenticationHelper authenticationHelper, CommentMapper commentMapper) {
...
//                    @Parameter(name = "postId", description = "post id", example = "5")
    ...
    public Comment updateComment(@RequestHeader HttpHeaders headers, @PathVariable int id, @PathVariable int postId, @Valid @RequestBody CommentDto commentDto) {
        try {
            ...
            Comment comment = this.commentMapper.fromDto(id, commentDto, post);
